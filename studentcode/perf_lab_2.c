/* This program demonstrates the uses/changes of type casting for print statements
* 
*  name: Robert Chunn
*  date: 06 Jan 2020
...
int main(void)
{
    ...
    printf("Value of float as a double is %.15f \n", (double)singlePrecision);
    // printf("size of double is %ld \n", sizeof(doublePrecision));
    printf("Value of double is %.15f \n", doublePrecision);
    printf("Value of double as a float is %.15f \n\n", (float)doublePrecision);
